...
# token.actions.githubusercontent.com. A bundle signed any other way
# (e.g. a local device-flow login while testing capture-evidence.sh)
# correctly fails this check - that's the identity boundary working as
